...
# Stock Price Prediction Section Ends Here
    ...
    st.markdown('<p class="big-font">LiveStock Tracker is a web application that allows users to visualize Stock Performance Comparison, Real-Time Stock Prices and Stock Price Prediction. This Project is developed by the Blackrock team :- Shaurya, Govind, Jahanavi, Arunain<br> Cheers!</p>', unsafe_allow_html=True)
